...
(
  ...
  esc_avaliacao TINYINT NOT NULL,
  PRIMARY KEY (esc_id)
);
...
CREATE TABLE Itinerario_per_coordGPS(
  ...
  iti_id INT NOT NULL,
  PRIMARY KEY (iti_coordGPS_data,iti_coordGPS_long,iti_coordGPS_lat, iti_coordGPS_alt),
